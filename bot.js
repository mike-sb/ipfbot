...
api.on('update', (update) => {
    ...
    switch (msg) {
        ...
        case "/entry":
            api.sendMessage({
                ...
                text: 'Вступительные испытания необходимы тем, кто не участвовал в сдаче ЕГЭ в 2021 году: \n1)Инвалиды \n2)Иностранные граждане' +
                    'Также вступительные испытания необходимо тем, кто: 1)Получил аттестат об общем среднем образовании и прошел \*итоговую аттестацию* по образовательной программе среднего общего образования в форме гос. экзамена. \n2)Если поступающий получил документ о среднем общем образовании в иностранной организации',
                parse_mode: 'Markdown',
        ...
        case "/olimp":
            api.sendMessage({
                chat_id: chat_id,
                text: 'При поступлении в МГТУ им. Баумана учитываются всероссийские олимпиады, олимпиада "Шаг в будущее", "Технокубок", "Газпром". Также учитываются призовые места в олимпиадах по профильным предметам.',
                parse_mode: 'Markdown',
        ...
        case "/ok_2021":
            api.sendMessage({
                chat_id: chat_id,
                text: 'В 2021 году  прием документов на платную и бюджетную основу заканчивается 29 июля. Для бюджетной формы обучения приём согласия на зачисление заканчивается 11 августа, для платной формы 19 августа. Для квотников 4 августа оканчивается прием согласия на зачисление и 6 августа формируются приказы о зачислении в МГТУ им. Баумана.',
                parse_mode: 'Markdown',
