...
api.on('update', (update) => {
    ...
    switch (msg) {
        case "/start":
            ...
            api.sendMessage({
                ...
                text: 'Дорогие абитуриенты, предлагаем Вам ознакомиться со списком часто задаваемых вопросов при поступлении в МГТУ им. Баумана на кафедру "Цифровая криминалистика": \n ' +
                    ...
                    '3) Какие предметы ЕГЭ необходимы для поступлени? /subs \n' +
        ...
        case "/subs":
            api.sendMessage({
                chat_id: chat_id,
                text: 'Список ЕГЭ по предметам, необходимых для поступления на кафедру ЮР2 "Цифровая криминалистика": \n1)Обществознание (минимальный балл: 45) \n2)Русский (минимальный балл: 40)\n3)История (минимальный балл: 40) *или* Математика профильная (минимальный балл: 45).\n ',
                parse_mode: 'Markdown',
            })
            break;
        case "/inst":
        ...
        case "/obsh":
            api.sendMessage({
                chat_id: chat_id,
                text: 'Да, есть. Общежитие предоставляется на конкурсной основе.',
                parse_mode: 'Markdown'
